...
import { Button, StyleSheet, Text, TouchableOpacity, View, Linking, Platform, Image, Pressable, Modal } from 'react-native';
...
export default function CameraPhone({navigation, qrData, setScanned, setQrData}) {
