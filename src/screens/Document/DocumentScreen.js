...
export default function DocumentScreen({navigation}) {
    ...
    return(
        <View style={{ flex: 1,alignItems:'center', justifyContent:'center', width:'100%', height:'100%', backgroundColor:'white'}}>
            {qrData.vhod === '2' 
            ?
     ...
     <View style={styles.centeredView}>
            ...
            <Text style={{marginBottom: 20, fontSize:18, fontWeight:'500', color:'#4d4d4d'}}>Сканируйте QR-код</Text>
            <View style={{width: 313, height:313, borderWidth:12, borderColor: '#D64D43', borderRadius:36, alignItems:'center', justifyContent:'center'}}>
            ...
            <TouchableOpacity style={{width:300, height: 50, backgroundColor:'#F5DBDA', alignItems:'center', justifyContent:'center', marginTop:20, borderRadius:15}} onPress={() => navigation.goBack()}>
                <Text style={{fontSize:18, fontWeight:'600', color:'#D64D43'}}>Назад</Text>
            </TouchableOpacity>
