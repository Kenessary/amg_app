...
export default function VerifyForPassword ({navigation, check}) {
      ...
      const otp = otp1 + otp2 + otp3 + otp4;
        if (otp === code) {
            Alert.alert(i18n.t('successVerify'), i18n.t('successVerifyText'), [
                {
                  text: 'OK',
                  onPress: () => {navigation.navigate('ChangePassword');setVisible1(false); setTimer(60); setOTP1(''); setOTP2(''); setOTP3(''); setOTP4('')},
                },
              ]);
        } else {
