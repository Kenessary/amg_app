    ...
    const tableHeader = (a) => (
        ...
        for (let i=0; i < doclist.length; i++){
          docs.push(
            ...
            <View key={i} style={{ width: windowWidth-40, marginBottom:10, height: 76, backgroundColor:'#F4F4F4', alignItems:'center', borderRadius: 15}}>
              <View style={{ width: windowWidth-90, height: 34, marginTop: 8}} >
                <View style={{flexDirection:'row'}}>
                  <Text style={{color: '#4D4D4D'}}>{i+1}. </Text>
                  <Text style={{color: '#4D4D4D'}}>{(doclist[i]).doc}</Text>
                </View>
                <View style={{ width: windowWidth-90, marginTop: 7, marginBottom: 8, flexDirection:'row', justifyContent:'flex-end'}}>
                  <View style={{flexDirection:'row', alignItems:'center'}}>
                    ...
                    <Text style={{marginLeft:2, color: '#4D4D4D'}}>{(doclist[i]).date}</Text>
                  </View>
