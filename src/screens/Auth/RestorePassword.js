  ...
  try {
    ...
    const validateRenew = () => {
        ...
        if(valid){
            back()
            logout()
            newPassword(globalThis.resiin, inputsRenew.parol)
   ...
   console.log( globalThis.resiin)
    ...
    return (
      ...
      <TouchableOpacity activeOpacity={0.7} onPress={()=>(navigation.navigate('LoginScreen'))} style={{marginLeft: 30, marginTop:30, display: visible1 === false ? 'flex' : 'none'}}>
