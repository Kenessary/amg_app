  ...
  return(
    ...
    return (
        <View style={{height:'100%', backgroundColor:'white'}}>
          ...
          <Text style={{fontSize:17, fontWeight:'600', color:'#4d4d4d'}} >Результаты на дату</Text>
          <Text style={{fontSize:17, fontWeight:'600', color:'#4d4d4d', marginTop:5, marginBottom:5}} >{date}</Text>
          <View style={{height:1, width:130, backgroundColor:'#4d4d4d'}}/>
          <Text style={{fontSize:17, fontWeight:'600', color:'#4d4d4d', marginTop:5}} >{dateClock}</Text>
