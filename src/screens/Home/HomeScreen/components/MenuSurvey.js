    ...
    return(
        ...
        <SafeAreaView style={[styles.menuOpros, {backgroundColor: theme.background}]}>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity style={[styles.buttonYes, {backgroundColor: isDarkMode === true ? "#C0D5EE" : '#D64D43'}]} onPress={()=> otvet(iin, 1, setIsLoading1, setOtvetOpros, setModalResult)}>
              <Text style={[styles.buttonYesText, {color: theme.background}]}>Да</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.buttonNo, {borderColor: isDarkMode === true ? "#C0D5EE" : "#D64D43"}]} onPress={()=> otvet(iin, 2, setIsLoading1, setOtvetOpros, setModalResult)}>
